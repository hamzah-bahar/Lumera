...
<div class='bg-white m-3 mb-12 px-3 pt-3 pb-12 shadow-article-shadow rounded-2xl w-[385px] h-[600px]'>
    <div class="relative rounded-3xl">
        <img src="{{ $article->image ? $article->imageUrl() : '/images/courseone.png' }}" alt="article-image" width="{{ $width }}" height="262px" class="m-auto clipPath rounded-2xl" />
