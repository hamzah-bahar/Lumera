            ...
            <div class="lg:col-span-1 lg:w-full lg:h-full lg:bg-linear-to-r lg:from-gray-50 lg:via-transparent lg:to-transparent dark:from-neutral-800">
                <div class="sticky top-0 start-0 py-8 lg:ps-8">
                    ...
                    <div class="gap-x-3 mt-12 mx-auto lg:max-w-screen-xl md:max-w-screen-md flex items-center border-b border-gray-200 pb-8 mb-8">
                        ...
                        <x-front.authorFollowWrapper class="grow" :user="$user">
                            <div class="flex justify-between">
                                ...
                                <div class="grow">
                                    <div class="flex justify-end">
                                        <button @click="follow()" type="button" :class="following ? 'bg-red-600' : 'bg-frontprimary'" class="py-1.5 px-2.5 inline-flex items-center gap-x-2 text-xs font-medium rounded-lg border border-transparent text-white focus:outline-hidden disabled:opacity-50 disabled:pointer-events-none">
